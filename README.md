...
- Bundled sample from a real Walmart weekly sales dataset in `data/raw/walmart_real_sales.csv`
...
The bundled dataset is a sample from the public Walmart weekly sales forecasting dataset hosted at:

...
The dataset used in `data/raw/walmart_real_sales.csv` is a representative multi-store sample from the public Hugging Face dataset `Ammok/walmart_sales_prediction`, which mirrors the common Walmart weekly sales forecasting dataset.
